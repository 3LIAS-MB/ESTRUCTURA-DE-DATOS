...
public class AVLTree<ELEMENT extends Comparable<ELEMENT>> { 
    ...
    // visitando cada nodo antes de sus descendientes.
    public void PreOrder() {
        PreOrder(this.root);
    }
    
    // Método protegido que realiza el recorrido en preorden desde 
    // un nodo dado, visitando cada nodo antes de sus descendientes.
    ...
    // Método protegido que realiza el recorrido en orden
    // descendente (inorden inverso) desde un nodo dado,
