...
//   this.root = new BTNode<ELEMENT>(item, null, null);
 ...
 public BinaryTree(ELEMENT item, BinaryTree<ELEMENT> left, BinaryTree<ELEMENT> right) {
     ...
     // En este caso la primera vez no pasa las condiciones
     if (right != null) {
...
// Si no, hacemos un calculo recursivo
 protected int MaxLevel(BTNode<ELEMENT> root) {
     if (root != null) {
    	 ...
    	 // vamos a sumar al 1 del nodo que ya tenemos. De manera obtenemos el max nivel
         if ( (root.left != null) || (root.right != null) ) {
